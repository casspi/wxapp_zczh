...
Page({
    ...
    formSubmit: function(e) { 
        ...
        if(formData.number=="" || formData.name==""|| formData.district==""|| formData.detail==""){
          ...
          if(app.globalData.edit_type=="add"){//如果是增地址
            wx.request({
                url: 'https://www.ahzczh.com/m.php?g=api&m=wxshop&a=add_address&sess_id='+wx.getStorageSync(
                      'sess_id'
                      ),
                data: {
              ...
              wx.request({
                url: 'https://www.ahzczh.com/m.php?g=api&m=wxshop&a=update_address&sess_id='+wx.getStorageSync('sess_id'),
                data: {
